...
contract CreationAttestationVerifierV2 is ICreationAttestationVerifierV2, EIP712, Ownable2Step {
    string public constant PROFILE_NAME = "inshell.thought.creation-workflow-attestation.v2";
    ...
    constructor(address initialOwner, address initialAuthority)
        EIP712("Inshell THOUGHT Creation Attestation", "2")
        Ownable(initialOwner)
    {
        if (initialAuthority == address(0)) revert InvalidAttestationAuthority();
