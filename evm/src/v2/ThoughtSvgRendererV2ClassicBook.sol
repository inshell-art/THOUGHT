...
/// @notice Experimental current-V2 SVG renderer using Set 5 Classic Book 76.
/// @dev Reads the exact immutable IM76 v1 packed payload and emits only glyphs used by a work.
contract ThoughtSvgRendererV2ClassicBook is IThoughtSvgRendererV2 {
    ...
    string public constant GLYPH_LIBRARY_MEMBER_ID = "inshell.thought.glyph-library.set-05.classic-book";
    ...
    bytes32 public constant GLYPH_PACKED_SHA256 =
        0x3ab51d7dcdce7e358e7c76002b8f78ddaa448a99de2116a238f7e22209f2bd60;
    ...
    uint256 private constant PACKED_BYTES = 2_540;
    uint256 private constant PACKED_HEADER_BYTES = 162;
    uint256 private constant PACKED_PATH_BYTES = 2_378;
    ...
    function _render(string calldata promptLine, string calldata agentLine) private view returns (string memory) {
        ...
        return string.concat(
            ...
            definitions,
            '<g id="prompt-line" fill="none" stroke="#00ff00" stroke-width="0.82" stroke-linecap="round" stroke-linejoin="round" data-source="',
            ...
            "</g>",
            '<g id="agent-line" fill="none" stroke="#00ff00" stroke-width="0.82" stroke-linecap="round" stroke-linejoin="round" data-source="',
