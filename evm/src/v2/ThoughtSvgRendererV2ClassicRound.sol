...
/// @notice Experimental current-V2 SVG renderer using Set 5 Classic Round 76.
/// @dev Reads the exact immutable IM76 v1 packed payload and emits only glyphs used by a work.
contract ThoughtSvgRendererV2ClassicRound is IThoughtSvgRendererV2 {
    error InvalidGlyphDataPointer();
    error TooManyRenderedRows();

    string public constant IMPLEMENTATION_ID =
        "inshell.thought.renderer.v2.classic-round-76-im76-native-paths-frame-32-006100-green-00ff00-prompt-top-agent-bottom";
    bytes32 public constant IMPLEMENTATION_ID_HASH = keccak256(bytes(IMPLEMENTATION_ID));
    string public constant GLYPH_LIBRARY_MEMBER_ID = "inshell.thought.glyph-library.set-05.classic-round";
    bytes32 public constant GLYPH_SOURCE_SHA256 =
        0x0df0f883818638295e60004d53be50078e550258ea6536275b581dfa69257913;
    bytes32 public constant GLYPH_PACKED_SHA256 =
        0x72ea88523caf278828b833368c4a3a289f7b80866ac464325d04f031c48e3a01;
    bytes32 public constant GLYPH_PACKED_KECCAK256 =
        0x55bf4234750664a8fc608d089e3f59074e3e1ae15f7082029888a6291d0de323;
    ...
    uint256 private constant PACKED_BYTES = 2_696;
    uint256 private constant PACKED_HEADER_BYTES = 162;
    uint256 private constant PACKED_PATH_BYTES = 2_534;
    ...
    function _render(string calldata promptLine, string calldata agentLine) private view returns (string memory) {
        ...
        return string.concat(
            ...
            definitions,
            '<g id="prompt-line" fill="none" stroke="#00ff00" stroke-width="0.86" stroke-linecap="round" stroke-linejoin="round" data-source="',
            ...
            "</g>",
            '<g id="agent-line" fill="none" stroke="#00ff00" stroke-width="0.86" stroke-linecap="round" stroke-linejoin="round" data-source="',
