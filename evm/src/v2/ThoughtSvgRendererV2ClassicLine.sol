...
/// @notice Experimental current-V2 SVG renderer using Set 5 Classic Line 76.
/// @dev Reads the exact immutable IM76 v1 packed payload and emits only glyphs used by a work.
contract ThoughtSvgRendererV2ClassicLine is IThoughtSvgRendererV2 {
    error InvalidGlyphDataPointer();
    error TooManyRenderedRows();

    string public constant IMPLEMENTATION_ID =
        "inshell.thought.renderer.v2.classic-line-76-im76-native-paths-frame-32-006100-green-00ff00-prompt-top-agent-bottom";
    bytes32 public constant IMPLEMENTATION_ID_HASH = keccak256(bytes(IMPLEMENTATION_ID));
    string public constant GLYPH_LIBRARY_MEMBER_ID = "inshell.thought.glyph-library.set-05.classic-line";
    bytes32 public constant GLYPH_SOURCE_SHA256 =
        0x5aca96cc7c349d59d7303e5f706442da4f54349233b8d297d722277fae4899bd;
    bytes32 public constant GLYPH_PACKED_SHA256 =
        0xd06f7403b4963d8f46e6e8559c7ab0e4a21a65aa3681b210bfe433d74ea56b42;
    bytes32 public constant GLYPH_PACKED_KECCAK256 =
        0x139753d435a99bff61fd410929e57f9038ab5772ccc7a35a26a76ee03545fb77;
    ...
    uint256 private constant PACKED_BYTES = 2_514;
    uint256 private constant PACKED_HEADER_BYTES = 162;
    uint256 private constant PACKED_PATH_BYTES = 2_352;
    ...
    function _render(string calldata promptLine, string calldata agentLine) private view returns (string memory) {
        ...
        return string.concat(
            ...
            definitions,
            '<g id="prompt-line" fill="none" stroke="#00ff00" stroke-width="0.72" stroke-linecap="round" stroke-linejoin="round" data-source="',
            ...
            "</g>",
            '<g id="agent-line" fill="none" stroke="#00ff00" stroke-width="0.72" stroke-linecap="round" stroke-linejoin="round" data-source="',
