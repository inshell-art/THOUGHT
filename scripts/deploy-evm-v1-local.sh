...
(
  ...
  forge create \
    ...
    --json \
    legacy/SeedGeneratorV1.sol:SeedGeneratorV1 >"$tmp_seed"
  ...
  forge create \
    ...
    --private-key "$PRIVATE_KEY" \
    --json \
    legacy/ColorFontV1.sol:ColorFontV1 >"$tmp_color_font"
  ...
  forge create \
    ...
    --private-key "$PRIVATE_KEY" \
    --json \
    legacy/ThoughtPreviewerV1.sol:ThoughtPreviewerV1 >"$tmp_previewer"
  ...
  forge create \
    ...
    --private-key "$PRIVATE_KEY" \
    --json \
    legacy/ThoughtSpecRegistryV1.sol:ThoughtSpecRegistryV1 \
...
(
  ...
  forge create \
    ...
    --private-key "$PRIVATE_KEY" \
    --json \
    legacy/ThoughtNFTV1.sol:ThoughtNFTV1 \
