...
The agent line renders as a square-corner speech frame with a center tail. The prompt line renders as a square-corner block near the bottom.
...
agent bg height = 96
agent bg rx = 0
agent bg fill = canvas bg
agent bg stroke = agent bg color
agent bg stroke width = 1
agent tail path = M 470 461 L 480 478 L 490 461 Z
agent tail fill = canvas bg
agent tail stroke = agent bg color
agent tail stroke width = 1
agent clip x = 88
agent clip y = 365
