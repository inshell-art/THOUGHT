...
export const thoughtV2TextCorpuses: ThoughtV2TextCorpus[] = [
  ...
  },
  {
    ...
    fixtures: [
      {
        id: "ascii-byte-limits",
        name: "work 44 ascii byte limits",
        promptLine: "p".repeat(64),
        agentLine: "A".repeat(64),
      },
      {
        id: "wide-byte-limits",
        name: "work 45 wide byte limits",
        promptLine: "你".repeat(21),
        agentLine: "好".repeat(21),
      },
      {
        id: "mixed-byte-limit",
        name: "work 46 mixed byte limit",
        promptLine: `${"a".repeat(31)} ${"你".repeat(10)}`,
        agentLine: `${"A".repeat(30)} ${"好".repeat(11)}`,
      },
    ],
  },
  {
    ...
    fixtures: [
      ...
      },
      {
        ...
        promptLine: "a".repeat(48),
        agentLine: "b".repeat(48),
      },
      {
        id: "density-126-cjk-bytes",
        name: "work 53 density 126 cjk bytes",
        promptLine: "你".repeat(21),
        agentLine: "好".repeat(21),
      },
    ],
