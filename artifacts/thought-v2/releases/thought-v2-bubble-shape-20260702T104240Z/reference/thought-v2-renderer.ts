...
const AGENT_BG = { x: 72, y: 365, width: 816, height: 96, radius: 14 };
const AGENT_CLIP = { x: 88, y: 365, width: 784, height: 96, radius: 14 };
...
const PROMPT_BG = { x: 150, y: 868, width: 660, height: 44, radius: 8 };
...
const DEFAULT_PROMPT_TEXT = "#000000";
const DEFAULT_AGENT_BG = "#000000";
...
export const buildThoughtV2Svg = ({
  ...
  return [
    ...
    `    <rect id="agent-line-bg" x="${AGENT_BG.x}" y="${AGENT_BG.y}" width="${AGENT_BG.width}" height="${AGENT_BG.height}" rx="${AGENT_BG.radius}" fill="${escapeXml(agentBg)}"/>`,
    `    <path id="agent-line-tail" d="${AGENT_TAIL_PATH}" fill="${escapeXml(agentBg)}"/>`,
