...
system-font lookup. Its equal 844.8-by-256 prompt and Agent fields are both
bottom aligned, fixing their final glyph-row baselines at `332.8` and `780.8`
for every accepted wrapped row count.
