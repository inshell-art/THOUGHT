...
response occupies an equal field at `(57.6,576)`. Both fields are bottom
aligned. The final prompt glyph-row baseline is always `332.8`; the final Agent
glyph-row baseline is always `780.8`, regardless of wrapped row count.
