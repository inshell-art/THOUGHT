...
at `832`. Both fields pack wrapped rows upward from their fixed bottom. The
final prompt glyph-row baseline is therefore always `332.8`, and the final
Agent glyph-row baseline is always `780.8`.
